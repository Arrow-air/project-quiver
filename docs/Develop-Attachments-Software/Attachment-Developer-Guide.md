...
Attachment sensor or actuator
   ...
   |-- CAN pair --> aircraft CAN2 / DroneCAN network
   `-- FMU_CH1 --> protected, revision-confirmed auxiliary interface
```
