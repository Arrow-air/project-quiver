---
title: BC_PCB Dev-Kit Assembly
sidebar_label: BC_PCB Dev-Kit Assembly
tags: [pcb]
---
...
Open the interactive BOM: [Quiver_PT3_BC_PCB_V0.1_ibom.html](pathname:///docs/project-quiver/Archive/PT3-Assembly-Guides/PCB-assembly/assets/Quiver_PT3_BC_PCB_V0.1_ibom.html)
...
An AMX-200 fuse needs to be mounted between J7 and J8. Please use Loctite to secure the screws.
